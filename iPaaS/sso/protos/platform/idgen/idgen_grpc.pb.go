...
type IdGenClient interface {
	// Sends a greeting
	GenerateID(ctx context.Context, in *GenRequest, opts ...grpc.CallOption) (*GenReply, error)
	GenerateIDs(ctx context.Context, in *GenerateIDsRequest, opts ...grpc.CallOption) (*GenerateIDsReply, error)
}
...
func (c *idGenClient) GenerateID(ctx context.Context, in *GenRequest, opts ...grpc.CallOption) (*GenReply, error) {
	out := new(GenReply)
	err := c.cc.Invoke(ctx, "/idgen.IdGen/GenerateID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *idGenClient) GenerateIDs(ctx context.Context, in *GenerateIDsRequest, opts ...grpc.CallOption) (*GenerateIDsReply, error) {
	out := new(GenerateIDsReply)
	err := c.cc.Invoke(ctx, "/idgen.IdGen/GenerateIDs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IdGenServer interface {
	// Sends a greeting
	GenerateID(context.Context, *GenRequest) (*GenReply, error)
	GenerateIDs(context.Context, *GenerateIDsRequest) (*GenerateIDsReply, error)
...
func (UnimplementedIdGenServer) GenerateID(context.Context, *GenRequest) (*GenReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GenerateID not implemented")
}
func (UnimplementedIdGenServer) GenerateIDs(context.Context, *GenerateIDsRequest) (*GenerateIDsReply, error) {
...
func _IdGen_GenerateID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/idgen.IdGen/GenerateID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IdGenServer).GenerateID(ctx, req.(*GenRequest))
	}
...
func _IdGen_GenerateIDs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/idgen.IdGen/GenerateIDs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IdGenServer).GenerateIDs(ctx, req.(*GenerateIDsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var IdGen_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protos/platform/idgen/idgen.proto",
}
