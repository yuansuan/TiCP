...
func ResourceBillList(ctx *gin.Context) {
	...
	if req.TradeType == 0 {
		common.ErrorResp(ctx, http.StatusBadRequest, consts.InvalidArgumentErrorCode, "trade type can not be empty")
		return
	}
	...
	resp, err := module.UserResourceBillList(ctx, req, userID)
