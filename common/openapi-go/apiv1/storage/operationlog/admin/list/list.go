...
type API func(options ...Option) (*admin.ListOperationLogResponse, error)

func New(hc *xhttp.Client) API {
	return func(options ...Option) (*admin.ListOperationLogResponse, error) {
		req, err := NewRequest(options)
		if err != nil {
			return nil, err
		}
		resolver := hc.Prepare(xhttp.NewRequestBuilder().
			URI("/admin/storage/operationLog").
		...
		ret := new(admin.ListOperationLogResponse)
...
func NewRequest(options []Option) (*admin.ListOperationLogRequest, error) {
	req := &admin.ListOperationLogRequest{}
...
type Option func(req *admin.ListOperationLogRequest) error

func (api API) PageSize(pageSize int64) Option {
	return func(req *admin.ListOperationLogRequest) error {
