...
export function useModel(props?: Partial<ModelProps>) {
  ...
  return useLocalStore(() => ({
    ...
    useRefresh: function useRefresh(
      isSyncToLocal,
      userName,
      ...
      const fetch = useCallback(
        async function fetch() {
          ...
          try {
            ...
            const dir = await server.fetch(node?.path, false, rawCloud,userName,store.filterRegexp)
