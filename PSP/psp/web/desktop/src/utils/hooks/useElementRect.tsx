...
export const createObserver = (
    ...
    if (maybeRateLimiter === undefined) {
        maybeRateLimiter = (cb) => _.throttle(cb, 16, { leading: true, trailing: true });
    }
...
export const useElementRect = <E extends HTMLElement>(ref: RefObject<E> | null, maybeRateLimiter?: RateLimiter | null) => {
