INSERT INTO TiCP.`resource` (`id`, `name`, `action`, `type`, `display_name`, `custom`, `external_id`, `parent_id`)
...
INSERT INTO TiCP.`role` (`id`, `name`, `comment`, `type`)
...
INSERT INTO TiCP.`casbin_rule` (`p_type`, `v0`, `v1`, `v2`)
VALUES ('p', 'r1', '1', 'NONE');
INSERT INTO TiCP.`casbin_rule` (`p_type`, `v0`, `v1`, `v2`)
VALUES ('p', 'r1', '2', 'NONE');
INSERT INTO TiCP.`casbin_rule` (`p_type`, `v0`, `v1`, `v2`)
...
-- 3d云应用权限
INSERT INTO TiCP.`resource` (`name`, `action`, `type`, `display_name`, `custom`, `external_id`, `parent_id`)
VALUES ('visual', 'NONE', 'system', '3D云应用', 1, 0, 0);

SET @max_id = (SELECT MAX(id) FROM TiCP.resource);
